 ...
 * @access 		public
 */
class BenchmarkFormSelectFieldtype extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function BenchmarkFormSelectFieldtype($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
        ...
        foreach(array('bigint','mediumint','smallint','int','tinyint','float','decimal','double','enum_varchar','enum_int','varchar','mediumtext','text','date','time','datetime','year') as $mode)
        	$this->addOption($mode, ucfirst($mode));
    }
