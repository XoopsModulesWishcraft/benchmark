...
insert  into `benchmark_fields` (`fid`,`name`,`type`,`required`,`primarykey`,`key`,`create_sql`,`alter_sql`,`size`,`recipricol`,`alter_type`,`created`) values (1,'id','int','_YES','_YES','common','INT(20) UNSIGNED NOT NULL AUTO_INCREMENT','INT(10) UNSIGNED NOT NULL AUTO_INCREMENT',20,0,'int', UNIX_TIMESTAMP());
insert  into `benchmark_fields` (`fid`,`name`,`type`,`required`,`primarykey`,`key`,`create_sql`,`alter_sql`,`size`,`recipricol`,`alter_type`,`created`) values (2,'tid','int','_YES','_NO','common','INT(10) UNSIGNED DEFAULT \'0\'','INT(20) UNSIGNED DEFAULT \'0\'',10,0,'int', UNIX_TIMESTAMP());
insert  into `benchmark_fields` (`fid`,`name`,`type`,`required`,`primarykey`,`key`,`create_sql`,`alter_sql`,`size`,`recipricol`,`alter_type`,`created`) values (3,'boolean','tinyint','_NO','_NO',NULL,'TINYINT(1) DEFAULT NULL','INT(1) DEFAULT NULL',1,0,'int', UNIX_TIMESTAMP());
insert  into `benchmark_fields` (`fid`,`name`,`type`,`required`,`primarykey`,`key`,`create_sql`,`alter_sql`,`size`,`recipricol`,`alter_type`,`created`) values (4,'bigint','bigint','_NO','_NO',NULL,'BIGINT(20) DEFAULT \'0\'','INT(35) DEFAULT \'0\'',20,0,'int', UNIX_TIMESTAMP());
insert  into `benchmark_fields` (`fid`,`name`,`type`,`required`,`primarykey`,`key`,`create_sql`,`alter_sql`,`size`,`recipricol`,`alter_type`,`created`) values (5,'mediumint','mediumint','_NO','_NO',NULL,'MEDIUMINT(20) DEFAULT \'0\'','BIGINT(15) DEFAULT \'0\'',20,0,'bigint', UNIX_TIMESTAMP());
insert  into `benchmark_fields` (`fid`,`name`,`type`,`required`,`primarykey`,`key`,`create_sql`,`alter_sql`,`size`,`recipricol`,`alter_type`,`created`) values (6,'smallint','smallint','_NO','_NO',NULL,'SMALLINT(20) DEFAULT \'0\'','INT(15) DEFAULT \'0\'',20,0,'int', UNIX_TIMESTAMP());
insert  into `benchmark_fields` (`fid`,`name`,`type`,`required`,`primarykey`,`key`,`create_sql`,`alter_sql`,`size`,`recipricol`,`alter_type`,`created`) values (7,'int','int','_NO','_NO',NULL,'INT(20) DEFAULT \'0\'','MEDIUMINT(16) DEFAULT \'0\'',20,0,'mediumint', UNIX_TIMESTAMP());
insert  into `benchmark_fields` (`fid`,`name`,`type`,`required`,`primarykey`,`key`,`create_sql`,`alter_sql`,`size`,`recipricol`,`alter_type`,`created`) values (8,'tinyiny','tinyint','_NO','_NO',NULL,'TINYINT(20) DEFAULT \'0\'','SMALLINT(14) DEFAULT \'0\'',20,0,'smallint', UNIX_TIMESTAMP());
insert  into `benchmark_fields` (`fid`,`name`,`type`,`required`,`primarykey`,`key`,`create_sql`,`alter_sql`,`size`,`recipricol`,`alter_type`,`created`) values (9,'float','float','_NO','_NO',NULL,'FLOAT(10,5) DEFAULT \'0.00000\'','DOUBLE(16,8) DEFAULT \'0.000000000\'',10,5,'double', UNIX_TIMESTAMP());
insert  into `benchmark_fields` (`fid`,`name`,`type`,`required`,`primarykey`,`key`,`create_sql`,`alter_sql`,`size`,`recipricol`,`alter_type`,`created`) values (10,'decimal','decimal','_NO','_NO',NULL,'DECIMAL(10,5) DEFAULT \'0.00000\'','FLOAT(16,8) DEFAULT \'0.00000000\'',10,5,'float', UNIX_TIMESTAMP());
insert  into `benchmark_fields` (`fid`,`name`,`type`,`required`,`primarykey`,`key`,`create_sql`,`alter_sql`,`size`,`recipricol`,`alter_type`,`created`) values (11,'double','double','_NO','_NO',NULL,'DOUBLE(10,5) DEFAULT \'0.00000\'','DECIMAL(16,8) DEFAULT \'0.00000000\'',10,5,'decimal', UNIX_TIMESTAMP());
insert  into `benchmark_fields` (`fid`,`name`,`type`,`required`,`primarykey`,`key`,`create_sql`,`alter_sql`,`size`,`recipricol`,`alter_type`,`created`) values (12,'enum_int','enum_int','_NO','_NO',NULL,'ENUM(%numbersassymbols%) DEFAULT NULL','SMALLINT(5) DEFAULT NULL',2,0,'smallint', UNIX_TIMESTAMP());
insert  into `benchmark_fields` (`fid`,`name`,`type`,`required`,`primarykey`,`key`,`create_sql`,`alter_sql`,`size`,`recipricol`,`alter_type`,`created`) values (13,'enum_varchar','enum_varchar','_NO','_NO',NULL,'ENUM(%numbersaswords%) DEFAULT NULL','VARCHAR(35) DEFAULT NULL',15,0,'varchar', UNIX_TIMESTAMP());
insert  into `benchmark_fields` (`fid`,`name`,`type`,`required`,`primarykey`,`key`,`create_sql`,`alter_sql`,`size`,`recipricol`,`alter_type`,`created`) values (14,'mediumtext','mediumtext','_NO','_NO',NULL,'MEDIUMTEXT','VARCHAR(3000) DEFAULT NULL',3000,0,'varchar', UNIX_TIMESTAMP());
insert  into `benchmark_fields` (`fid`,`name`,`type`,`required`,`primarykey`,`key`,`create_sql`,`alter_sql`,`size`,`recipricol`,`alter_type`,`created`) values (15,'text','text','_NO','_NO',NULL,'TEXT','VARCHAR(3000) DEFAULT NULL',3000,0,'varchar', UNIX_TIMESTAMP());
insert  into `benchmark_fields` (`fid`,`name`,`type`,`required`,`primarykey`,`key`,`create_sql`,`alter_sql`,`size`,`recipricol`,`alter_type`,`created`) values (16,'date','date','_NO','_NO',NULL,'DATE DEFAULT NULL','VARCHAR(12) DEFAULT NULL',12,0,'varchar', UNIX_TIMESTAMP());
insert  into `benchmark_fields` (`fid`,`name`,`type`,`required`,`primarykey`,`key`,`create_sql`,`alter_sql`,`size`,`recipricol`,`alter_type`,`created`) values (17,'time','time','_NO','_NO',NULL,'TIME DEFAULT NULL','VARCHAR(6) DEFAULT NULL',6,0,'varchar', UNIX_TIMESTAMP());
insert  into `benchmark_fields` (`fid`,`name`,`type`,`required`,`primarykey`,`key`,`create_sql`,`alter_sql`,`size`,`recipricol`,`alter_type`,`created`) values (18,'datetime','datetime','_NO','_NO',NULL,'DATETIME DEFAULT NULL','VARCHAR(20) DEFAULT NULL',20,0,'varchar', UNIX_TIMESTAMP());
insert  into `benchmark_fields` (`fid`,`name`,`type`,`required`,`primarykey`,`key`,`create_sql`,`alter_sql`,`size`,`recipricol`,`alter_type`,`created`) values (19,'varchar','varchar','_NO','_NO',NULL,'VARCHAR(255) DEFAULT NULL','MEDIUMTEXT',255,0,'mediumtext', UNIX_TIMESTAMP());
insert  into `benchmark_fields` (`fid`,`name`,`type`,`required`,`primarykey`,`key`,`create_sql`,`alter_sql`,`size`,`recipricol`,`alter_type`,`created`) values (20,'created','int','_YES','_NO','made','INT(12) DEFAULT \'0\'','MEDIUMINT(12) DEFAULT \'0\'',12,0,'mediumint', UNIX_TIMESTAMP());
insert  into `benchmark_fields` (`fid`,`name`,`type`,`required`,`primarykey`,`key`,`create_sql`,`alter_sql`,`size`,`recipricol`,`alter_type`,`created`) values (21,'year','year','_NO','_NO',NULL,'YEAR DEFAULT NULL','VARCHAR(4) DEFAULT NULL',4,0,'varchar', UNIX_TIMESTAMP());
