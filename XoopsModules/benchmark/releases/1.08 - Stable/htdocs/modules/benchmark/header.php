<?php
	...
	ini_set('memory_limit', (empty($GLOBALS['xoopsModuleConfig']['memory_limit'])?'128M':$GLOBALS['xoopsModuleConfig']['memory_limit']));
	set_time_limit(($GLOBALS['xoopsModuleConfig']['time_limit']==0?3600:$GLOBALS['xoopsModuleConfig']['time_limit']));
