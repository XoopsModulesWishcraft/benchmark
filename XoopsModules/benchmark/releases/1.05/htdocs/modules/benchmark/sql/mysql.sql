...
insert  into `benchmark_fields` (`fid`,`name`,`type`,`required`,`primarykey`,`key`,`create_sql`,`alter_sql`,`size`,`recipricol`,`alter_type`,`created`) values (14,'mediumtext','mediumtext','_NO','_NO',NULL,'MEDIUMTEXT','VARCHAR(2000) DEFAULT NULL',2000,0,'varchar', UNIX_TIMESTAMP());
insert  into `benchmark_fields` (`fid`,`name`,`type`,`required`,`primarykey`,`key`,`create_sql`,`alter_sql`,`size`,`recipricol`,`alter_type`,`created`) values (15,'text','text','_NO','_NO',NULL,'TEXT','VARCHAR(2000) DEFAULT NULL',2000,0,'varchar', UNIX_TIMESTAMP());
...
CREATE TABLE `benchmark_tables` (
  ...
  `tid` int(10) unsigned DEFAULT '0',
  `fids` varchar(2000) DEFAULT NULL,
  `name` varchar(128) DEFAULT NULL,
...
CREATE TABLE `benchmark_tests` (
  ...
  `note` mediumtext,
  `tbids_create` varchar(2000) DEFAULT NULL,
  `tbids_select` varchar(2000) DEFAULT NULL,
  `tbids_insert` varchar(2000) DEFAULT NULL,
  `tbids_update` varchar(2000) DEFAULT NULL,
  `tbids_updateall` varchar(2000) DEFAULT NULL,
  `tbids_delete` varchar(2000) DEFAULT NULL,
  `tbids_deleteall` varchar(2000) DEFAULT NULL,
  `tbids_alter` varchar(2000) DEFAULT NULL,
  `tbids_rename` varchar(2000) DEFAULT NULL,
  `tbids_smarty` varchar(2000) DEFAULT NULL,
