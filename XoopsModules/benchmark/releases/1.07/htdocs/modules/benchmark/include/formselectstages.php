 ...
 * @access 		public
 */
class BenchmarkFormSelectStages extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function BenchmarkFormSelectStages($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
        ...
        foreach(array('_MI_BENCHMARK_WAIT','_MI_BENCHMARK_PREPARED','_MI_BENCHMARK_TESTING','_MI_BENCHMARK_CLEANUP','_MI_BENCHMARK_FINISHED') as $mode)
