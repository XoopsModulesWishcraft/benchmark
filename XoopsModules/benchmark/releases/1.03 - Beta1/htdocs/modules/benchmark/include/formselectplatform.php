 ...
 * @access 		public
 */
class BenchmarkFormSelectPlatform extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function BenchmarkFormSelectPlatform($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
        ...
        foreach(array('_MI_BENCHMARK_XOOPS24','_MI_BENCHMARK_XOOPS25','_MI_BENCHMARK_XOOPS26','_MI_BENCHMARK_XOOPS27','_MI_BENCHMARK_XOOPS28','_MI_BENCHMARK_XOOPS29','_MI_BENCHMARK_XOOPS30','_MI_BENCHMARK_XOOPS31','_MI_BENCHMARK_XOOPSCUBE','_MI_BENCHMARK_ICMS') as $mode)
