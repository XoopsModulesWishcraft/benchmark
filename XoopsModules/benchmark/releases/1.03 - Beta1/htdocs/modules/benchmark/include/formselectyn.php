 ...
 * @access 		public
 */
class BenchmarkFormSelectYN extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function BenchmarkFormSelectYN($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
        ...
        foreach(array('_YES','_NO') as $mode)
        	$this->addOption($mode, ucfirst(constant($mode)));
    }
