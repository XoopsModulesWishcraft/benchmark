 ...
 * @access 		public
 */
class BenchmarkFormSelectEngine extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function BenchmarkFormSelectEngine($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
        ...
        foreach(array('INNODB','MYISAM') as $mode)
